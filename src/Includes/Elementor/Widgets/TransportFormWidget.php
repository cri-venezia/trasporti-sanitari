...
class TransportFormWidget extends Widget_Base {
	...
	protected function render(): void {
		...
		$form_html .= '<div id="domicilio-fields" class="conditional-field"><p><label for="piano">' . esc_html__( 'Piano', 'cri-trasporti' ) . '</label><input type="text" id="piano" name="piano"></p><p><label for="ascensore">' . esc_html__( 'Ascensore', 'cri-trasporti' ) . '</label><select id="ascensore" name="ascensore"><option value="si">' . esc_html__( 'Sì', 'cri-trasporti' ) . '</option><option value="no">' . esc_html__( 'No', 'cri-trasporti' ) . '</option></select></p><div id="scale-fields" class="conditional-field"><p><label for="larghezza_scale">' . esc_html__( 'Larghezza Scale', 'cri-trasporti' ) . '</label><select id="larghezza_scale" name="larghezza_scale"><option value="ampie">' . esc_html__( 'Ampie', 'cri-trasporti' ) . '</option><option value="strette">' . esc_html__( 'Strette', 'cri-trasporti' ) . '</option></select></p></div></div>';
